...
public class Lexer implements ILexer {
    ...
    public Token next() throws LexicalException {
        ...
        switch(firstChar){
            ...
            case '!':{
                switch(nextChar(startPos)){
                    case '=':{
                        pos++;
                        column++;
                        return new Token(new SourceLocation(line, startColumn), Kind.NOT_EQUALS, "!=");
                    }
                    default:{
                        return new Token(new SourceLocation(line, startColumn), Kind.BANG, String.valueOf(firstChar));
                    }
                }
            }
            ...
            case '0':
                if(nextChar(pos) != '.' ){
                    return new Token(new SourceLocation(line, startColumn), Kind.INT_LIT, "0", 0);
                }
            case '1':
            case '2':
            case '3':
            ...
            case '9':{
                ...
                if(nextChar(pos) != '.'){
                    ...
                    try {
                        ...
                        throw new LexicalException("Improper float value");
                    }
                }
            }
            case 0:
            ...
            default:{
                ...
                if(idenStart.contains(String.valueOf(firstChar))){
                    ...
                    throw new LexicalException("Unexpected character: " + String.valueOf(firstChar), line, column);
                }
